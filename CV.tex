...
\newcommand{\pub}[3]{%
  % Forces notes to appear on the left
  {\reversemarginpar\strut\marginnote{{\small\makebox[1.2cm][l]{#1}{#2}\\\makebox[1.55cm][r]{#3}}}}%
}
...
%
\pub{}{p1}{}Discussion sur l'évolution de l'univers\\G.\ Lemaître
