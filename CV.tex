...
\newcommand{\pub}[3]{%
  % Forces notes to appear on the left
  {\reversemarginpar\strut\marginnote{{\small\makebox[0.5cm][l]{#1}\makebox[0.5cm][r]{ }{#2}\\\makebox[1.03cm][r]{ }{#3}}}}%
}
...
\pub{1946}{p4}{}%
%
The Primeval Atom --- An Essay on Cosmogony\\G.\ Lemaître\\[.2cm]
%
\pub{1931}{p3}{}%
L'Hypothèse de l'atome primitif\\G.\ Lemaître\\[.2cm]
%
\pub{1927}{p222}{\faTrophy}%
%
\emph{Un univers homogène de masse constante et de rayon
croissant rendant compte de la vitesse radiale des nébuleuses
extragalactiques}, Annals of the Scientific Society of Brussels, 47A:41.\\G.\ Lemaître \\[.2cm] 
%
\pub{}{p1}{\faMedal}Discussion sur l'évolution de l'univers\\G.\ Lemaître
